...
summary: We present an occlusion-aware multi-view depth estimation with adaptive normal constraint, whose estimated depth maps could keep geometric features.
